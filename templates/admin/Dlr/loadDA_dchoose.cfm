   ...
   <!-- ----------------------------------------------------------- -->
	<!--- $Id: loadDA_dchoose.cfm,v 1.6 1999/11/29 15:34:12 lswanson Exp $ --->
...
<CFIF OK EQ 1> 
	...
	<TR>
		<TD>
			...
			<FORM NAME="Find1" ACTION="loadDA_dchoose2.cfm" METHOD="post">
			<TR>
...
<TR ALIGN=CENTER>
	<TD>
		...
		<INPUT TYPE="image" SRC="<CFOUTPUT>#application.RELATIVE_PATH#</CFOUTPUT>/images/admin/cancel_nav.jpg" VALUE="CANCEL" NAME="CANCEL" BORDER="0">
		</FORM>
	</TD>
</TR>
