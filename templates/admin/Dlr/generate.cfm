...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
    ...
    <!-- ----------------------------------------------------------- -->
	<!--- $Id: generate.cfm,v 1.5 1999/11/29 15:36:34 lswanson Exp $ --->
...
<table cellpadding=0 cellspacing=0 border=0 width=450 align=center>
   ...
   <tr>
       ...
       <td><SELECT NAME="template" SIZE=1>
                  <CFOUTPUT QUERY="getTemplates">
                          <OPTION VALUE="#q_TemplateLocation#">#q_Description#
                          </CFOUTPUT>
                   </SELECT></td>
   </tr>
   <tr><td colspan=3>&nbsp;<p></td></tr>
   <tr>
       <td colspan=3 align=center><input type="submit" value="Create Logo"> <p>
           <A HREF="#" OnClick="JavaScript:document.generator.reset();"><IMG SRC="<CFOUTPUT>#application.RELATIVE_PATH#</CFOUTPUT>/images/admin/reset_nav.jpg" Border="0" NAME="Reset" value="Reset"></a></td>
   </tr>
   <tr><td colspan=3>&nbsp;<p></td></tr>
</table>
</form>
