...
<HTML>
    ...
    <!--               conceive : construct : connect                -->
    <!-- ----------------------------------------------------------- -->
	<!--- $Id: webnew_s6b.cfm,v 1.7 1999/11/29 15:30:58 lswanson Exp $ --->
	<!--- Service Profile --->
	...
	<!----
		...
		THE FORM ACTION IS HARD CODED TO "WEBNEW_S6C.CFM"    -HML
	--->
...
<CFIF EditMode>
	<CFQUERY NAME="getText" datasource="#gDSN#">
			SELECT ServiceMainText as q_ServiceProfileMainText
			FROM DealerWebs
			WHERE DealerWebs.DealerCode = '#g_DealerCode#'
	</CFQUERY>     
	
	<CFIF #getText.q_ServiceProfileMainText# EQ ''>
		<CFSET EditMode = FALSE>
		<CFSET NewMode = TRUE>
	</CFIF>
</CFIF>
...
<CFIF EditMode>
	...
	<CFSET q_mod_SvcProfileTxt = #Replace(getText.q_ServiceProfileMainText,"<BR>",Chr(13),"ALL")#>
	<!---
	Check if 2nd paragraph is "bullet items" or "paragraph"
	Encoded as follows:  
	...
	--->
	<CFSET section_break_1  = #Find ("~~",q_mod_SvcProfileTxt,1)#>
	<!---
		Break up q_mod_SvcProfileTxt into 1st paragraph
	--->
	<CFSET section_1_text = #Mid(q_mod_SvcProfileTxt,1, (section_break_1 - 1))#>
	<CFSET which_type = #Mid(q_mod_SvcProfileTxt,(section_break_1 + 2), 1)#>
	...
	<CFIF #section_2_type# IS NOT 'None'>
			...
			--->
			<CFSET section_break_2 = #Find ("~~~~",q_mod_SvcProfileTxt,1)#>
			...
			<CFIF section_3_type>
					...
					<CFIF #section_2_type# IS 'Paragraph'>
						<CFSET section_2_text = #Mid(q_mod_SvcProfileTxt,(section_break_1 + 4),(section_break_2 - section_break_1) -	4)#>
					<CFELSE>
						<!--- bullet list--->
						<CFSET section_2_bullet = #Mid(q_mod_SvcProfileTxt,(section_break_1 + 4),(section_break_2 - section_break_1) - 4)#>
					</CFIF>
					<!--- Get length of q_mod_svcProfileTxt --->
					<CFSET how_long = #Len(q_mod_SvcProfileTxt)#>
					<!--- Grab 3rd paragraph --->
					<CFSET section_3_text = #Mid(q_mod_SvcProfileTxt,(section_break_2 + 4), how_long)#>			
			<CFELSE> <!--- No 3rd paragraph --->
					<!---
					Get length of q_mod_svcProfileTxt variable
					--->
					<CFSET how_long = #Len(q_mod_SvcProfileTxt)#>
					<CFSET section_2_bullet = #Mid(q_mod_SvcProfileTxt,(section_break_1 + 4), how_long)#>
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=410 BGCOLOR="FFFFFF">
        ...
        <TR>
            <TD>
                  <FORM NAME="StepSix" ACTION="webnew_s6c.cfm" METHOD="post">
                  <TABLE CELLSPACING=0 CELLPADDING=0 BORDER=0 WIDTH="100%">
			 <TR>
			 	<TD ALIGN=CENTER>
					<FONT FACE="Arial,Helvetica">
						Your service profile consists of up to three portions.  They will be displayed as text, in order,
						on the service profile page of your web site.
					</FONT>
				</TD>
			</TR>
			<TR><TD>&nbsp;<p></TD></TR>
            <TR ALIGN=center>
				<TD><FONT FACE="arial,helvetica">
			 	<b>In the space below, enter the first portion of your service profile.</b><p>
				</FONT>
				</TD>
			</TR>
            <CFIF EditMode>
				...
				<TR ALIGN=CENTER>
					<TD><FONT FACE="Arial,Helvetica">
						In the second portion of your service profile, you may enter up to six "bullet items,"
					...
					<FONT FACE="arial,helvetica">
					<p>
					<b>Please select the format for the second portion of your service profile:</b></FONT></TD></TR>
				<TR ALIGN=CENTER>
					<TD>
						<FONT SIZE=2 FACE="arial,helvetica">
                 ...
                 <TR>
                             <TD>
							 	<FONT FACE="arial,helvetica" SIZE=2>
                                <textarea name="section_1_text" cols="40" rows="10" wrap="PHYSICAL">Enter your Service Profile here.</textarea>
								</FONT>
                                </TD>
                             </TR>
				...
				<TR ALIGN=CENTER>
					...
					<I>Please note: If you select "No Second Portion", you will not be given the option to enter a third portion.</I>
					<p></FONT>
					<b>Please select how many "bullet items" you wish to enter: </b></TD></TR>
				<TR ALIGN=CENTER>
					<TD>
						<FONT FACE="arial,helvetica">
						<SELECT name="bullet_items">
		...
		<CFIF EditMode>
			<TR><TD ALIGN=center>
				<FONT FACE="arial,helvetica"><b>
					Do you wish to enter a third portion of text for this service profile?
				</b></FONT><br>&nbsp;</TD></TR>
			 <TR><TD ALIGN=center>
			 	<FONT FACE="arial,helvetica">
					<b>Yes</b>&nbsp;<INPUT
		...
		<CFELSE>
			 ...
			 <TR><TD ALIGN=center>
			 	<FONT FACE="arial,helvetica"><b>
					Yes</b>&nbsp;<INPUT type="radio" name="yes_no" value="1" CHECKED>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <CFOUTPUT>
            ...
            <INPUT TYPE="hidden" NAME="NextStep" VALUE="webnew_s6c.cfm">
                &nbsp;&nbsp;
            <INPUT TYPE="Image" SRC="<CFOUTPUT>#application.RELATIVE_PATH#</CFOUTPUT>/images/admin/cancel_nav.jpg" BORDER="0" NAME="btnCancel" VALUE="Cancel">
                &nbsp;&nbsp;
            <INPUT TYPE="Image" SRC="<CFOUTPUT>#application.RELATIVE_PATH#</CFOUTPUT>/images/admin/next_nav.jpg" BORDER="0" NAME="btnNext" VALUE="Save">
                </FORM>
            <p>
