   ...
   <!-- ----------------------------------------------------------- -->
	<!--- $Id: webfind2.cfm,v 1.6 1999/11/29 15:30:57 lswanson Exp $ --->
...
<HEAD>
	<TITLE>WorldDealer | Select a Collection/Dealer</TITLE>
...
<TABLE CELLPADDING=5 CELLSPACING=0 BORDER=0 WIDTH=420 BGCOLOR="FFFFFF">
	<TR><TD>&nbsp;<p></TD></TR>
	<TR ALIGN="center">
		<TD><h3><FONT FACE="Arial,Helvetica">Maintain Your Web Site<BR></FONT></h3></TD>
	</TR>
	
	<TR align="center">
		<TD><FONT FACE="Arial,Helvetica">Please select a collection or dealership below, then click <B>Modify</B>.
		<CFIF Left(AccessLevel, 1) EQ application.SYSADMIN_ACCESS>
...
<CFIF ParameterExists(Form.Collection)>
	...
	<TR><TD>&nbsp;<p></TD></TR>		
 	...
 	<TR ALIGN="center">
		<TD><h4><font face="Arial,Helvetica">Modify Collection</font></h4></TD>
	</TR>
	
	<TR ALIGN="center">
		<FORM NAME="FindColl" ACTION="webvrfy.cfm" METHOD="post">
	...
	<TR ALIGN="center">
		<TD>
			<INPUT TYPE="Image" SRC="<CFOUTPUT>#application.RELATIVE_PATH#</CFOUTPUT>/images/admin/modify.jpg" Border="0" NAME="btnNext" VALUE="Modify">
			</FORM>
		</TD>
	</TR>
	...
	<TR ALIGN="center">
		<TD><h4><font face="Arial,Helvetica">Modify Dealer</font></h4></TD>
	</TR>
...
<CFELSE>
	...
	<TR ALIGN="center">
		...
		Click <CFIF Left(AccessLevel, 1) EQ application.SYSADMIN_ACCESS>the 'New Search' button to return to the search form, or click  </cfif>the 'New Dealer' button to add a dealer from scratch.</font></h4></TD>
	</TR>
	<TR><TD>&nbsp;<p></TD></TR>
	<TR ALIGN="center">
		<TD>
