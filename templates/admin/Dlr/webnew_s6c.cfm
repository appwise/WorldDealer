...
<HTML>
    ...
    <!--               conceive : construct : connect                -->
    <!-- ----------------------------------------------------------- -->
	<!--- $Id: webnew_s6c.cfm,v 1.6 1999/11/29 15:30:58 lswanson Exp $ --->
	<!--- Service Profile --->
...
<CFIF SaveMode>
<!--- Parse the form variables and convert the entire ServiceProfile back into one HTML string --->
	...
	<CFQUERY NAME="updateDLR" datasource="#gDSN#">
                     UPDATE DealerWebs
                     SET ServiceMainText = '#final_text#'
					 WHERE DealerWebs.DealerCode='#g_DealerCode#'
	</CFQUERY>
	<CFLOCATION URL="webvrfy_s6b.cfm?dlrcode=#g_DealerCode#">
</CFIF> <!--- CFIF SaveMode --->
...
<br><br><br><br><br>
	...
	<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=410 BGCOLOR="FFFFFF">
        <TR ALIGN="center">
			<TD ALIGN="middle">
				<h3><font face="Arial,Helvetica">Dealer Administration - Create a New Web</font></h3>
			</TD>
        </TR>
        <TR ALIGN="center">
            <TD ALIGN="middle">
				<font face="Arial,Helvetica">Enter the following information.  Required fields are bolded.</font>
			</TD>
        </TR>
        <FORM NAME="StepSix" ACTION="webnew_s6c.cfm" METHOD="post">
        <TR><TD>&nbsp;<p></TD></TR>
		<TR><TD ALIGN=CENTER><FONT FACE="arial,helvetica"><b>Portion One:</FONT></TD></TR>
		<TR>
			<TD align=center>
		...
		<CFIF #FORM.Bullet_Items# EQ 'text'>
		 	<TR>
				<TD align=CENTER><FONT FACE="arial,helvetica">
					<b>In the space below, enter the second portion of your service profile</b><br>
		...
		<CFELSE> <!--- Bullet List --->
			<TR>
				<TD ALIGN=CENTER>
					...
					Enter the bullet items for your second portion in the spaces below.</b><p>
					<CFLOOP from=1 to=#form.bullet_items# index="count">
						<CFOUTPUT>
						<CFIF IsDefined ("form.bullet_#count#")>  <!---Edit mode --->
							<CFSET temp = #Evaluate("form.bullet_#count#")#>
		...
		<CFIF #Form.Yes_No# EQ '1'>
			...
			<TR>
				<TD align=CENTER>
					<FONT FACE="arial,helvetica"><b>
					In the space below, enter the third portion of your service profile.</b><br>
					</FONT>
					<FONT FACE="arial,helvetica" SIZE=2>
