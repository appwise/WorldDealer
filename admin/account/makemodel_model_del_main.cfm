...
<!---$Id: makemodel_model_del_main.cfm,v 1.5 2000/05/18 23:53:08 lswanson Exp $ --->
<!--- Account Intro --->
...
<cfif IsDefined("Form.delModels.X")>
	...
	<form action="makemodel_model_del_action.cfm" method="POST">
	...
	<tr>
		...
		<tr>
			<td><b>#getModels.Description#</b></td>
		</tr>
		</cfoutput>
		</cfloop>
		</table><p>
...
<cfelse>
	...
	<tr>
		<td align="CENTER" valign="TOP">
			<form action="makemodel_model_del.cfm" method="POST">
			<input type="hidden" name="make" value="<cfoutput>#url.make#</cfoutput>">
			<table border="0" cellspacing="0" cellpadding="2">
			<cfloop query="getModels">
			<cfoutput>
			<tr>
				<td><input type="Checkbox" name="ModelNumber" value="#ModelID#"></td>
				<td>#Description#</td>
			</tr>
			</cfoutput>
			</cfloop>
