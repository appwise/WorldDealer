...
<!---$Id: makemodel_del_main.cfm,v 1.5 2000/05/18 23:53:08 lswanson Exp $ --->
<!--- Account Intro --->
...
<cfif IsDefined("Form.delMakes.X")>
	...
	<form action="makemodel_del_action.cfm" method="POST">
...
<cfelse>
	...
	<tr>
		<td align="CENTER" valign="TOP">
			<form action="makemodel_del.cfm" method="POST">
			<table border="0" cellspacing="0" cellpadding="2">
