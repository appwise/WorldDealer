...
<cfelse>
	...
	<cfset g_host_ip = "198.79.25.51"> <!--- On the Production Site this needs to be an IP address due to DNS problems --->
	<cfset g_rootdir = "e:\worlddealer"> <!--- The Worlddealer Web Root directory path --->
<!--- 	
<cfelse>
	<!--- if laptop --->
...
<!--- <cfif #cgi.server_name# eq "olympus.sigma6.com" or 
	...
	<CFSET g_imagegen = "http://198.79.25.53:8081/sigma6/servlet/ImageGenerator"> <!--- URL of the ImageGenerator --->
	<CFSET g_imagegen2 = '198.79.25.53'> <!--- Host name of the ImageGenerator --->
	<CFSET g_mapper = "http://198.79.25.53"> <!-------- Mapper location, which is Wddegen server ---->
	<cfset g_webtrends = "http://198.79.25.53/webtrends/worlddealer">
<!--- 	
<cfelse>
	<!--- if laptop --->
