...
<!---$Id: err_tallbanner.cfm,v 1.1 2000/06/22 16:33:30 jkrauss Exp $--->
   
<cfmodule template="/util/DumpDebug.cfm" text="begin $RCSfile: err_tallbanner.cfm,v $">
...
<tr align="center">
	<td>
		<h3>Text Area is too tall.</h3>
	</td>
</tr>
<tr align="center">
	<td>
		The banner is only 48 pixels tall.<br>
		The <b>Pixels From Top</b> and <b>Text Area Height</b> must total less than 48.  
		<br><br>
...
<cfmodule template="/util/DumpDebug.cfm" text="end   $RCSfile: err_tallbanner.cfm,v $" printtrace="true">